...
/*
Widget Name: Accordion Widget (Gutwerker)
Description: A awesome accordion widget
Author: Kevin Taron
Author URI: https://gutwerker.de
Version: 1.0
*/

class GWSOB_Accordion_Widget extends SiteOrigin_Widget {
    ...
    function __construct() {
        parent::__construct(
            ...
            array(
                'description' => __('A responsive accordion widget.', 'gw-so-bundle'),
            ),
            array(
...
siteorigin_widget_register('gwsob-accordion', __FILE__, 'GWSOB_Accordion_Widget');