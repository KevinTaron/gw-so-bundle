...
/*
Widget Name: Imagebox Widget (Gutwerker)
...
class GWSOB_Imagebox_Widget extends SiteOrigin_Widget {

    function __construct() {
        parent::__construct(
            'gwsob-imagebox',
            __('Imagebox (GW)', 'gw-so-bundle'),
            array(
                'description' => __('A responsive Google style Imagebox widget.', 'gw-so-bundle'),
...
siteorigin_widget_register('gwsob-imagebox', __FILE__, 'GWSOB_Imagebox_Widget');